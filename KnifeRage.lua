...
do
    ...
    function __i1j2k3:__desync_start(__c3d4e5)
        ...
        self.__conn2 = __y5z6a7.Heartbeat:Connect(function()
            ...
            -- ターゲットの頭（HitboxHead）を取得、なければHRPにフォールバック
            local __tHead = __c3d4e5.Character:FindFirstChild("HitboxHead") or __i9j0k1
            
            -- 頭の7.5スタッド上にTPし、体をうつ伏せ（真下を向く）にする
            -- CFrame.AnglesのX軸を-90度（-math.rad(90)）にして真下を向かせる
            __f6g7h8.CFrame = CFrame.new(__tHead.Position + Vector3.new(0, 7.5, 0)) * CFrame.Angles(-math.rad(90), 0, 0)
